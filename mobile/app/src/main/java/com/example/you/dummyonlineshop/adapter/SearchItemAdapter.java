...
public class SearchItemAdapter extends RecyclerView.Adapter<SearchItemAdapter.ViewHolder> {
    ...
    public SearchItemAdapter(List<Item> listBarang) {
    ...
    public SearchItemAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        view = LayoutInflater.from(parent.getContext()).inflate(R.layout.recycleview_search_item, parent, false);
        return new SearchItemAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(SearchItemAdapter.ViewHolder holder, final int position) {
